...
"""Test bitcoinpaythroughd aborts if can't disconnect a block.

- Start a single node and generate 3 blocks.
- Delete the undo data.
- Mine a fork that requires disconnecting the tip.
- Verify that bitcoinpaythroughd AbortNode's.
"""
...
class AbortNodeTest(BitcoinpaythroughTestFramework):
