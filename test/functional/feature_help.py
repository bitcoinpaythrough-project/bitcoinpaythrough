...
"""Verify that starting bitcoinpaythrough with -h works as expected."""

from test_framework.test_framework import BitcoinpaythroughTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinpaythroughTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinpaythrough with -h for help text")
        ...
        self.log.info("Start bitcoinpaythrough with -version for version information")
        ...
        self.log.info("Start bitcoinpaythroughd with -fakearg to make sure it does not start")
