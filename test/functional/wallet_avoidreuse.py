...
class AvoidReuseTest(BitcoinpaythroughTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 BPH with
        the avoid_reuse flag set to false. This means the 10 BPH send should succeed,
    ...
    def test_fund_send_fund_send(self):
        ...
        [0] sends 10 BPH to A.
        [1] spends 5 BPH from A. (leaving roughly 5 BPH useable)
        [0] sends 10 BPH to A again.
        [1] tries to spend 10 BPH (fails; dirty).
        [1] tries to spend 4 BPH (succeeds; change address sufficient)
        '''
