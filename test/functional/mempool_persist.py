...
By default, bitcoinpaythroughd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinpaythroughTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinpaythroughd from writing mempool.dat to disk. Verify that `savemempool` fails")
