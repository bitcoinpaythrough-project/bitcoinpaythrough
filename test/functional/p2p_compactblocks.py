...
# TestP2PConn: A peer we use to send messages to bitcoinpaythroughd, and store responses.
...
class CompactBlocksTest(BitcoinpaythroughTestFramework):
    ...
    # This test actually causes bitcoinpaythroughd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinpaythroughd's choice of nonce.
    ...
    # Test that bitcoinpaythroughd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcoinpaythroughd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # bitcoinpaythroughd will not send blocktxn responses for blocks whose height is
