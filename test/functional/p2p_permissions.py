...
class P2PPermissionsTests(BitcoinpaythroughTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bitcoinpaythroughconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].bitcoinpaythroughconf, 'w', encoding="utf8") as f:
            f.write(newText)
