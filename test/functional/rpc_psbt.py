...
class PSBTTest(BitcoinpaythroughTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 BPH
        ...
        # feeRate of 0.1 BPH / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 BPH / KB produces a total fee well above -maxtxfee
