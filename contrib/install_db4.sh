...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bitcoinpaythrough repository."
  exit 1
fi
...
# See https://github.com/bitcoinpaythrough/bitcoinpaythrough/issues/16064
...
echo 'When compiling bitcoinpaythroughd, run `./configure` in the following way:'
echo
