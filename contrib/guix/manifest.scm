...
(define* (make-bitcoinpaythrough-cross-toolchain target
                                  #:key
...
desirable for building Bitcoinpaythrough Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-bitcoinpaythrough-cross-toolchain "i686-linux-gnu")
       (make-bitcoinpaythrough-cross-toolchain "x86_64-linux-gnu")
       (make-bitcoinpaythrough-cross-toolchain "aarch64-linux-gnu")
       (make-bitcoinpaythrough-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-bitcoinpaythrough-cross-toolchain "riscv64-linux-gnu"
