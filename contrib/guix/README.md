# Bootstrappable Bitcoinpaythrough Core Builds

This directory contains the files necessary to perform bootstrappable Bitcoinpaythrough
Core builds.
...
- 24GB of free disk space on the partition that the Bitcoinpaythrough Core git repository
  resides in
...
For a Bitcoinpaythrough Core depends development environment, simply invoke
...
From the top of a clean Bitcoinpaythrough Core repository:
...
To use dongcarl's substitute server for Bitcoinpaythrough Core builds after having
