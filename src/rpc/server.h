...
#ifndef BITCOINPAYTHROUGH_RPC_SERVER_H
#define BITCOINPAYTHROUGH_RPC_SERVER_H
...
/**
 * Bitcoinpaythrough RPC command dispatcher.
 */
class CRPCTable
{
private:
...
#endif // BITCOINPAYTHROUGH_RPC_SERVER_H
