...
#ifndef BITCOINPAYTHROUGH_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINPAYTHROUGH_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoinpaythrough.
 *
 ...
 *
 * The chacha20-poly1305@bitcoinpaythrough combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoinpaythrough cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoinpaythrough are relatively fast in
...
#endif // BITCOINPAYTHROUGH_CRYPTO_CHACHA_POLY_AEAD_H
