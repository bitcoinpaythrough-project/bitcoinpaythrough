...
{
    const char* pszTimestamp = "Bitcoin pay through start at 2020/7/5";
...
public:
    CMainParams() {
        ...
        // consensus.defaultAssumeValid = uint256S("0x0000000000000000000f2adce67e49b0b6bdeb9de8b7c3d7e93b21e7fc1e819d"); // 597379
        ...
        genesis = CreateGenesisBlock(1594052040, 3184, 0x20000fff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000156086859346b79e950bb7c18aabc31171f81ab865c653321b7094acfd4bf"));
        assert(genesis.hashMerkleRoot == uint256S("0xdde25d481612b1eecdc04206eeae3bb11e1e6d2fb35bf18a8ca4c2aed58d5f6a"));
        ...
        vSeeds.emplace_back("8.210.152.78");
