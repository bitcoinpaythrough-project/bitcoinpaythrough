...
#ifndef BITCOINPAYTHROUGH_TEST_SCRIPTNUM10_H
#define BITCOINPAYTHROUGH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcoinpaythrough Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINPAYTHROUGH_TEST_BIGNUM_H
