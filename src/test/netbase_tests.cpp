...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinpaythroughcore.org", "www.bitcoinpaythroughcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinpaythroughcore.org]", "www.bitcoinpaythroughcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinpaythroughcore.org:80", "www.bitcoinpaythroughcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinpaythroughcore.org]:80", "www.bitcoinpaythroughcore.org", 80));
