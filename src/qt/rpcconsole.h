...
#ifndef BITCOINPAYTHROUGH_QT_RPCCONSOLE_H
#define BITCOINPAYTHROUGH_QT_RPCCONSOLE_H
...
/** Local Bitcoinpaythrough RPC console. */
...
#endif // BITCOINPAYTHROUGH_QT_RPCCONSOLE_H
