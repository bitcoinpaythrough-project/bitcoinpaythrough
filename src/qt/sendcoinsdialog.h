...
#ifndef BITCOINPAYTHROUGH_QT_SENDCOINSDIALOG_H
#define BITCOINPAYTHROUGH_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinpaythroughs */
...
#endif // BITCOINPAYTHROUGH_QT_SENDCOINSDIALOG_H
