    ...
    mapper(nullptr)
{
    ...
    ui->bitcoinpaythroughAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoinpaythroughAtStartup);
    ...
    ui->bitcoinpaythroughAtStartup->setToolTip(ui->bitcoinpaythroughAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoinpaythroughAtStartup->setText(ui->bitcoinpaythroughAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinpaythroughConfButton->setToolTip(ui->openBitcoinpaythroughConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinpaythroughUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinpaythroughAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinpaythroughConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinpaythroughConf())
