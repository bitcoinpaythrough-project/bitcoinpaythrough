...
#ifndef BITCOINPAYTHROUGH_QT_PAYMENTSERVER_H
#define BITCOINPAYTHROUGH_QT_PAYMENTSERVER_H

// This class handles payment requests from clicking on
// bitcoinpaythrough: URIs
//
...
#endif // BITCOINPAYTHROUGH_QT_PAYMENTSERVER_H
