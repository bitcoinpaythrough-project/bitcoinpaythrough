...
static void SetupBitcoinpaythroughTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinpaythrough-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoinpaythrough-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinpaythrough transaction\n" +
            "or:     bitcoinpaythrough-tx [options] -create [commands]   Create hex-encoded bitcoinpaythrough transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinpaythrough transaction
