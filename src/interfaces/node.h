...
#ifndef BITCOINPAYTHROUGH_INTERFACES_NODE_H
#define BITCOINPAYTHROUGH_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinpaythrough node (bitcoinpaythroughd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINPAYTHROUGH_INTERFACES_NODE_H
