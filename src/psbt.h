...
#ifndef BITCOINPAYTHROUGH_PSBT_H
#define BITCOINPAYTHROUGH_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual Bitcoinpaythrough transaction.) Returns true if the merge succeeded, false otherwise. */
...
#endif // BITCOINPAYTHROUGH_PSBT_H
