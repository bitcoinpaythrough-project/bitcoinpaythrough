...
#ifndef BITCOINPAYTHROUGH_WALLET_WALLET_H
#define BITCOINPAYTHROUGH_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinpaythrough from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Bitcoinpaythrough Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this bitcoinpaythrough node, and set to 0 for transactions that were created
...
#endif // BITCOINPAYTHROUGH_WALLET_WALLET_H
