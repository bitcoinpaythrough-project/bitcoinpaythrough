Fuzz-testing Bitcoinpaythrough Core
==========================
...
```
git clone https://github.com/bitcoinpaythrough-core/qa-assets
...
To build Bitcoinpaythrough Core using AFL instrumentation (this assumes that the
