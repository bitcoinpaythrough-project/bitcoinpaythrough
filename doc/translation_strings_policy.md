...
This document provides guidelines for internationalization of the Bitcoinpaythrough Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinpaythrough_en.ts` remains unchanged.
