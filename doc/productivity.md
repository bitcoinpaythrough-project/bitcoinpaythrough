...
```sh
make src/bitcoinpaythroughd src/bitcoinpaythrough-cli
make src/qt/bitcoinpaythrough-qt
make -C src bitcoinpaythrough_bench
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bitcoinpaythrough/bitcoinpaythrough.git
```
