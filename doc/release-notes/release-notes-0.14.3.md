Bitcoinpaythrough Core version *0.14.3* is now available from:

  <https://bitcoinpaythrough.org/bin/bitcoinpaythrough-core-0.14.3/>
...
- #10451 `3612219` contrib/init/bitcoinpaythroughd.openrcconf: Don't disable wallet by default (Luke Dashjr)
