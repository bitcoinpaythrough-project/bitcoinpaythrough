Bitcoinpaythrough Core version 0.9.2.1 is now available from:

  https://bitcoinpaythrough.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BPH to 0.01 BPH
...
- Fix "Start bitcoinpaythrough on system login"
