Bitcoinpaythrough-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinpaythrough/files/Bitcoinpaythrough/bitcoinpaythrough-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcoinpaythrough
...
New/changed settings (command-line or bitcoinpaythrough.conf file)
--------------------------------------------------------
