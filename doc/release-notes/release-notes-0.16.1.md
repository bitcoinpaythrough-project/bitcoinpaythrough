Bitcoinpaythrough Core version 0.16.1 is now available from:

  <https://bitcoinpaythroughcore.org/bin/bitcoinpaythrough-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitcoinpaythroughd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitcoinpaythroughd processes are cleaned up when tests end (sdaftuar)
