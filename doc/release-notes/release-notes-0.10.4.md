Bitcoinpaythrough Core version 0.10.4 is now available from:

  <https://bitcoinpaythrough.org/bin/bitcoinpaythrough-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinpaythrough-tx into its own package
- #6953 `dfe0d4d` Include bitcoinpaythrough-tx binary on Debian/Ubuntu
