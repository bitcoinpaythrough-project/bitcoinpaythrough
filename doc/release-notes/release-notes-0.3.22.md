Download URL: https://sourceforge.net/projects/bitcoinpaythrough/files/Bitcoinpaythrough/bitcoinpaythrough-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BPH fee schedule (users still pay 0.01 BPH per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinpaythrough00 - #bitcoinpaythrough99
