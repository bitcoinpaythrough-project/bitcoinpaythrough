Bitcoinpaythrough version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinpaythrough/files/Bitcoinpaythrough/bitcoinpaythrough-0.5.4/
...
http://gitorious.org/bitcoinpaythrough/bitcoinpaythroughd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcoinpaythrough-Qt notifications under Growl 1.3.
Increase required age of Bitcoinpaythrough-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinpaythrough properly when installing Bitcoinpaythrough-Qt over it. (Windows)
