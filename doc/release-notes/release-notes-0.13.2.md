Bitcoinpaythrough Core version 0.13.2 is now available from:

  <https://bitcoinpaythrough.org/bin/bitcoinpaythrough-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinpaythrough-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinpaythrough-tx to create v2 transactions (btcdrak)
