Bitcoinpaythrough Core version 0.9.4 is now available from:

  https://bitcoinpaythrough.org/bin/0.9.4/
...
this update is incompatible with the Bitcoinpaythrough system and could lead to consensus
forks.

Bitcoinpaythrough Core released binaries from https://bitcoinpaythrough.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinpaythrough/+archive/ubuntu/bitcoinpaythrough
- A third-party or self-compiled Bitcoinpaythrough Core

upgrade to Bitcoinpaythrough Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
