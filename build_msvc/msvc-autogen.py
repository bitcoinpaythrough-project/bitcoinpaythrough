...
libs = [
    'libbitcoinpaythrough_cli',
    'libbitcoinpaythrough_common',
    'libbitcoinpaythrough_crypto',
    'libbitcoinpaythrough_server',
    'libbitcoinpaythrough_util',
    'libbitcoinpaythrough_wallet_tool',
    'libbitcoinpaythrough_wallet',
    'libbitcoinpaythrough_zmq',
    'bench_bitcoinpaythrough',
]
...
def main():
    parser = argparse.ArgumentParser(description='Bitcoinpaythrough-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/bitcoinpaythrough_config.h'), os.path.join(SOURCE_DIR, 'config/bitcoinpaythrough-config.h'))
