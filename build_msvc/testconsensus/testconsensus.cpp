...
// bitcoinpaythrough includes.
#include <..\src\script\bitcoinpaythroughconsensus.h>
...
int main()
{
    std::cout << "bitcoinpaythroughconsensus version: " << bitcoinpaythroughconsensus_version() << std::endl;
    ...
    auto op0Result = bitcoinpaythroughconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bitcoinpaythroughconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
